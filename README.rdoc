...
You will now need to extend Active Progress in your particular User Model. This extends your model and allows
for additional methods from Active Progress.
