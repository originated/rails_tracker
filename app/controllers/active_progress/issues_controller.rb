require_dependency "active_progress/application_controller"
...
module ActiveProgress
  class IssuesController < ApplicationController
    ...
    def index
      ...
      @issues = @github.all(:user => ActiveProgress.config.user,
                            :repo => ActiveProgress.config.repo,
                            :state => "open",
                            :labels => ActiveProgress.config.labels)
    end
